...
unknown_button = Button(image=cross_img, bg=BACKGROUND_COLOR, highlightbackground=BACKGROUND_COLOR,
                        highlightthickness=0, command=next_card)
unknown_button.grid(row=1, column=0)

check_img = PhotoImage(file="./images/right.png")
known_button = Button(image=check_img, bg=BACKGROUND_COLOR, highlightbackground=BACKGROUND_COLOR,
